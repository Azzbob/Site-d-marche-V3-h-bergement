<?php
// ============================================================
//  identite.php  —  Page catégorie Identité
// ============================================================
session_start();
require_once 'db.php';
...
// Récupère tous les liens de la catégorie "Identité" (id=1)
$stmt = $pdo->prepare(
    "SELECT l.*, c.nom AS cat_nom
     FROM liens l
     LEFT JOIN categories c ON c.id = l.categorie_id
     WHERE l.actif = 1 AND c.nom = 'Identité'
...
// Gestion ajout/retrait favori (requête AJAX-like via POST)
...
$page_title = 'Identité – Liens Démarches';
$extra_css  = '<style>
/* ── Page Identité ── */
.page-header {
  text-align: center;
...
<div class="page-header">
  <h1 class="page-header__title">Identité</h1>
  <p class="page-header__sub">Toutes vos démarches liées à l'identité en un seul endroit</p>
</div>
