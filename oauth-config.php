...
define('GOOGLE_REDIRECT_URI',  'http://localhost/site-liens-d-marche-v2-main/google-callback.php');

// ── FACEBOOK ────────────────────────────────────────────────
define('FACEBOOK_APP_ID',      '1641623910282628');
define('FACEBOOK_APP_SECRET',  '895a72d4ab70e008c74fedbf35f6dc28');
define('FACEBOOK_REDIRECT_URI','http://localhost/site-liens-d-marche-v2-main/facebook-callback.php');
...
define('APPLE_REDIRECT_URI',   'http://localhost/site-liens-d-marche-v2-main/apple-callback.php');