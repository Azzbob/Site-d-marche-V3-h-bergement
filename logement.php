...
$stmt = $pdo->prepare(
    "SELECT l.*, c.nom AS cat_nom
     ...
     WHERE l.actif = 1 AND c.nom = 'Logement'
...
<div class="page-header">
  <h1 class="page-header__title">Logement</h1>
  <p class="page-header__sub">Toutes vos démarches liées au logement en un seul endroit</p>
</div>
